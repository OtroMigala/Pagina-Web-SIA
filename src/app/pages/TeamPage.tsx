...
const teamMembers = [
  ...
  },
  {
    ...
    role: "Líder de Propulsión",
    area: "Propulsión Aeroespacial",
    level: "Investigador JuniorSenior",
    fig: "Fig. 7c",
    initials: "SC",
    color: "#F5C518",
    bio: "Experto en diseño de motores cohete y sistemas de propulsión híbrida. Coordinador del proyecto KATARI Society.",
    publications: 3,
    projects: 4,
  },
  {
    name: "Ing. Sofía Torres",
    role: "Especialista en Satélites",
    area: "Sistemas Espaciales",
    level: "Investigadora Senior",
    fig: "Fig. 7d",
    initials: "ST",
    color: "#E8A800",
    bio: "Ingeniera aeronáutica con especialización en pequeños satélites. Lidera el proyecto ASTRA-1 CubeSat.",
    publications: 2,
    projects: 3,
  },
  {
    name: "Est. Juliana López",
    role: "Investigadora GNC",
    area: "Control & Navegación",
    level: "Semillerista",
    fig: "Fig. 7e",
    initials: "JL",
    color: "#F5C518",
    bio: "Estudiante de Ingeniería Aeronáutica. Desarrolla algoritmos de control y navegación para UAVs y cohetes de sondeo.",
    publications: 1,
    projects: 2,
  },
  {
